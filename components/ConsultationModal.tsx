          ...
          <div className="p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-1">
                <label className="block text-sm font-semibold text-slate-700 ml-1">학생 성명</label>
                <input
                  required
              ...
              <div className="space-y-1">
                <label className="block text-sm font-semibold text-slate-700 ml-1">연락처</label>
                <input
                  required
                  disabled={isSubmitting}
                  type="tel"
              ...
              <div className="space-y-1">
                <label className="block text-sm font-semibold text-slate-700 ml-1">학교 및 학년</label>
                <input
                  required
                  disabled={isSubmitting}
                  type="text"
